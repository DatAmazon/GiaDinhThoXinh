        ...
        <ContentTemplate>
            ...
            <div class="wrap">
                <div class="show-list">
                    ...
                    <asp:GridView ID="dgv" runat="server" AutoGenerateColumns="False" OnRowDataBound="dgvCategory_RowDataBound" DataKeyNames="PK_iAccountID" OnSelectedIndexChanged="dgvCategory_SelectedIndexChanged" Width="560px">
                        <Columns>
                ...
                <div class="func">
                    <div class="form-func">
                        <p>
                            ...
                            <asp:TextBox ID="txtAccountID" runat="server" Enabled="false" Width="184px"></asp:TextBox>
                        </p>
                        <%--                <p>
                    ...
                    <asp:RequiredFieldValidator ID="rName" runat="server" ControlToValidate="txtPermissionUser" ErrorMessage="Quyền không được bỏ trống"
                        ...
                        <asp:Repeater runat="server" ID="rptPermission">
                            <ItemTemplate>
                                <p>
                                    <a class="permission-name" href="<%#Eval("sPermissionName")%>"></a>
                                </p>
                            </ItemTemplate>
                        </asp:Repeater>
                        <p>
