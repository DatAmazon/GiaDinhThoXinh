        ...
        <div class="func">
            <div class="form-func">
                ...
                <p>
                    ...
                    <asp:TextBox ID="txtOrderID" runat="server" Width="184px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rName" runat="server" ControlToValidate="txtOrderID" ErrorMessage="Mã hóa đơn không được bỏ trống"
                ...
                <p>
                    ...
                    <asp:RequiredFieldValidator ID="reState" runat="server" ControlToValidate="txtProductID" ErrorMessage="Mã sản phẩm không được bỏ trống"
                        ForeColor="Red" Display="None" ValidationGroup="checkGroup"></asp:RequiredFieldValidator>
                </p>
                <p>
